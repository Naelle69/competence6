    ...
    <div class="navbar ml-4"> 
      <div class="contentmobile">
        <div class="rechercher" href="lien">
          <img src="images/svg-icones/loupemarron.svg" alt="Rechercher" width="20"/>
        </div>
        <div class="home" href="lien">
          <img src="images/svg-icones/home.svg" alt="Rechercher" width="20"/>
        </div>
        <div class="contactnavigation">
          <div class="telephone" href="lien">
            <img src="images/svg-icones/telephonemarron.svg" alt="Panier" width="19"/> 
          </div>
          <div class="enveloppe" href="lien">
            <img src="images/svg-icones/enveloppe.svg" alt="Mon compte" width="20"/>
          </div>
          <div class="facebook" href="lien">
            <img src="images/svg-icones/facebookmarron.svg" alt="Panier" width="19"/> 
          </div>
          <div class="instagram" href="lien">
            <img src="images/svg-icones/instagrammarron.svg" alt="Mon compte" width="20"/>
          </div>
        </div>
        <div class="client">
          <div class="panier" href="lien">
            <img src="images/svg-icones/paniermarron.svg" alt="Panier" width="19"/> 
          </div>
          <div class="moncompte" href="lien">
            <img src="images/svg-icones/moncompte.svg" alt="Mon compte" width="20"/>
          </div>
        </div>
      </div>
    </div>
    <div class="contenuhomepage mr-4">
      ...
      <div class="pokgourmet w-70 mb-4">
        ...
        <!-- <button class="bouton1 mb-8" name="button" type="button"> Découvrir nos produits </button>
         -->
        <?php include("tools/boutton2.php"); ?>
      </div>
      <?php include("tools/boutton4.php"); ?>
      ...
      <div class="offredelasemaine w-full">
        ...
        <div class="offre">
            ...
            <?php include("tools/boutton1.php"); ?>

...
<nav class="navbarweb z-10">
      <a class="navbarlogo" href="#">
        <img src="images/logobeige.svg" width="90" alt="POK'GOURMET Logo"/>
      </a>
      ...
      <ul class="menunav justify-content-space-between" width="400">
        ...
        <li class="menunav-item">
          <a class="h5menu disabled">
            <router-link to="/Notreblog">Blog conseils</router-link>
          </a>
        </li>
      </ul>
      ...
      <div class="client">
        <!-- Icon -->
        <a class="panier" href="#">
          <img src="images/svg-icones/paniermarron.svg" height="30" alt="POK'GOURMET Logo"/>
        </a>
        <a class="moncompte">
          <img src="images/svg-icones/moncompte.svg" height="30" alt="POK'GOURMET Logo"/>
        </a>
      </div>
</nav>

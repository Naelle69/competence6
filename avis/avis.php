...
<div class="nosavis mb-10 relative snap-mandatory snap-x overflow-auto" >
        ...
        <div class="avis1">
          <div class="icones">
            <div class="cercleavis">
              <img class="iconesavis1" src="images/svg-icones/couverts.svg"/>
            </div>
            <div class="cercleavis">
              <img class="iconesavis1" src="images/svg-icones/bolle.svg"/>
            </div>
          </div>
          <div class="avis">
      ...
      <div class="mx-4 shrink-0 scroll-ml-4 snap-center md:shrink">
        <div class="avis1">
          <div class="icones">
            <div class="cercleavis">
              <img class="iconesavis1" src="images/svg-icones/etoilemarron.svg"/>
            </div>
            <div>
              <img class="iconesavis2" src="images/svg-icones/emoji.svg"/>
            </div>
            <div class="cercleavis">
              <img class="iconesavis1" src="images/svg-icones/etoilemarron.svg"/>
            </div>
      ...
      <div class="mx-4 shrink-0 scroll-ml-4 snap-center md:shrink">
        <div class="avis1">
          <div class="icones">
            <div class="cercleavis">
              <img class="iconesavis1" src="images/svg-icones/app1.svg"/>
            </div>
            <div class="cercleavis">
              <img class="iconesavis1" src="images/svg-icones/app2.svg"/>
            </div>
          </div>
          <div class="avis">
